...
# IMAGE LOADING
# ============================================================================
def load_image(image_path: str, image_base_dir: str = POPE_IMAGE_DIR) -> Image.Image:
...
# ============================================================================
# STEP 2: MODEL B JUDGES CORRECTNESS (yes/no)
# ============================================================================
def step2_judge_correctness(
...
def run_pipeline(args):
    ...
    judged_results = step2_judge_correctness(
...
Examples:
  ...
  python inference_method1.py \\
    ...
    if args.benchmark not in ['pope', 'rwqa', 'mmvet', 'hallusion']:
